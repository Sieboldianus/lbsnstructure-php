...
namespace Lbsn\Structure\PostReaction;
 ...
 *
 * Protobuf type <code>lbsn.structure.PostReaction.ReactionType</code>
 */
class ReactionType
{
    /**
...
class_alias(ReactionType::class, \Lbsn\Structure\PostReaction_ReactionType::class);
