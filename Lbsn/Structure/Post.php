...
final class Post extends \Google\Protobuf\Internal\Message
{
    ...
    private $post_latlng = '';
    /**
     * Generated from protobuf field <code>.lbsn.structure.CompositeKey place_pkey = 3;</code>
     */
    private $place_pkey = null;
    /**
     * Generated from protobuf field <code>.lbsn.structure.CompositeKey city_pkey = 4;</code>
     */
    private $city_pkey = null;
    /**
     * Generated from protobuf field <code>.lbsn.structure.CompositeKey country_pkey = 5;</code>
     */
    private $country_pkey = null;
    /**
     * Generated from protobuf field <code>.lbsn.structure.CompositeKey user_pkey = 6;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.lbsn.structure.Language post_language = 25;</code>
     */
     ...
     *           Only if lat/lng coordinates are available, otherwise substitude this location information from place, city or country table
     *           and modify post_geoaccuracy to "place", "city", or "country". Formatting: WKT (Well-Known-Text String)
     *     @type \Lbsn\Structure\CompositeKey $place_pkey
     *     @type \Lbsn\Structure\CompositeKey $city_pkey
     *     @type \Lbsn\Structure\CompositeKey $country_pkey
     ...
     *          Type of input device used by the user to post, for a list see Twitter, e.g. "Web", "IPhone", "Android" etc., recommendation: should be oriented at Twitter source types.
     *     @type \Lbsn\Structure\Language $post_language
     *          A BCP 47 language identifier corresponding to the (machine-detected language) of the Post body-text, empty/whitespace if no language could be detected, NULL if not specified.
