...
namespace Lbsn\Structure\Post;

use UnexpectedValueException;

/**
 * Protobuf type <code>lbsn.structure.Post.PostGeoaccuracy</code>
 */
...
class_alias(PostGeoaccuracy::class, \Lbsn\Structure\Post_PostGeoaccuracy::class);
