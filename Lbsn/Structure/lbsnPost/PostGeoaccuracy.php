...
namespace Lbsn\Structure\lbsnPost;

use UnexpectedValueException;

/**
 * Protobuf type <code>lbsn.structure.lbsnPost.PostGeoaccuracy</code>
 */
...
class_alias(PostGeoaccuracy::class, \Lbsn\Structure\lbsnPost_PostGeoaccuracy::class);
